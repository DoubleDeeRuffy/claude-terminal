...
@.planning/ROADMAP.md
@.planning/STATE.md
@.planning/phases/30-support-nsis-silent/30-CONTEXT.md
@.planning/phases/30-support-nsis-silent/30-RESEARCH.md
@build-assets/installer-custom.nsh
@src/main/windows/SetupWizardWindow.js
...
<output>
After completion, create `.planning/phases/30-support-nsis-silent/30A-SUMMARY.md`
</output>
