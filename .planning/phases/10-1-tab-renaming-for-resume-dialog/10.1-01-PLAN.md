...
@.planning/ROADMAP.md
@.planning/STATE.md
@.planning/phases/10-1-tab-renaming-for-resume-dialog/10.1-RESEARCH.md
@src/renderer/ui/components/TerminalManager.js
@styles/projects.css
</context>
...
<output>
After completion, create `.planning/phases/10-1-tab-renaming-for-resume-dialog/10.1-01-SUMMARY.md`
</output>
