...
module.exports = {
  ...
  fields: [
    { type: 'select',   key: 'action',      label: 'Action',
      options: ['read', 'write', 'append', 'copy', 'delete', 'exists', 'move', 'list'] },
    { type: 'text',     key: 'path',        label: 'Chemin',       mono: true, placeholder: '/path/to/file' },
    { type: 'text',     key: 'destination', label: 'Destination',  mono: true, placeholder: '/path/to/dest',
      showIf: (p) => p.action === 'copy' || p.action === 'move' },
    { type: 'textarea', key: 'content',     label: 'Contenu',
      showIf: (p) => p.action === 'write' || p.action === 'append' },
    { type: 'text',     key: 'pattern',     label: 'Pattern',      mono: true, placeholder: '*.js',
