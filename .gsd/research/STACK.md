...
After removing the dotfile guard, dotfiles and dotfolders (`.gsd`, `.claude`, `.env`, `.gitignore`, `.github`, etc.) will appear. The `.git` directory remains hidden via `IGNORE_PATTERNS`.
