...
@.gsd/ROADMAP.md
@.gsd/STATE.md
@.gsd/phases/11-explorer-natural-sorting/11-RESEARCH.md
@.gsd/phases/1.1-dotfile-visibility-setting/1.1-01-SUMMARY.md
@src/renderer/ui/components/FileExplorer.js
@src/renderer/ui/panels/SettingsPanel.js
@src/renderer/state/settings.state.js
@src/renderer/i18n/locales/en.json
...
<output>
After completion, create `.gsd/phases/11-explorer-natural-sorting/11-01-SUMMARY.md`
</output>
