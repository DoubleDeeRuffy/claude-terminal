...
@.gsd/ROADMAP.md
@.gsd/STATE.md
@.gsd/phases/20-bugfix-swap-projects-selected-tab/20-RESEARCH.md
@src/renderer/ui/components/TerminalManager.js
</context>
...
<output>
After completion, create `.gsd/phases/20-bugfix-swap-projects-selected-tab/20-01-SUMMARY.md`
</output>
