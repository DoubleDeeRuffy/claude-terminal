...
@.gsd/ROADMAP.md
@.gsd/STATE.md
@.gsd/phases/16-remember-tab-names-of-claude-sessions-through-app-restarts/16-RESEARCH.md
...
<output>
After completion, create `.gsd/phases/16-remember-tab-names-of-claude-sessions-through-app-restarts/16-01-SUMMARY.md`
</output>
