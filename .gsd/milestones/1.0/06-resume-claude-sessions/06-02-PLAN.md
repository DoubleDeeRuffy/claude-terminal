...
@.gsd/ROADMAP.md
@.gsd/STATE.md
@.gsd/phases/06-resume-claude-sessions/06-RESEARCH.md
@.gsd/phases/06-resume-claude-sessions/06-01-PLAN.md
@src/renderer/ui/components/TerminalManager.js
@renderer.js
</context>
...
<output>
After completion, create `.gsd/phases/06-resume-claude-sessions/06-02-SUMMARY.md`
</output>
