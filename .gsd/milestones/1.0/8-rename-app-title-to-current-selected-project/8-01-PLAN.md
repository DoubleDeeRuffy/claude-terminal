...
@.gsd/ROADMAP.md
@.gsd/STATE.md
@.gsd/phases/8-rename-app-title-to-current-selected-project/8-RESEARCH.md
</context>
...
<output>
After completion, create `.gsd/phases/8-rename-app-title-to-current-selected-project/8-01-SUMMARY.md`
</output>
