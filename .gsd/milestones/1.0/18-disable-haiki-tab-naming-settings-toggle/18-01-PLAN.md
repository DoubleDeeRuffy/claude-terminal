...
@.gsd/ROADMAP.md
@.gsd/STATE.md
@.gsd/phases/18-disable-haiki-tab-naming-settings-toggle/18-RESEARCH.md
...
<output>
After completion, create `.gsd/phases/18-disable-haiki-tab-naming-settings-toggle/18-01-SUMMARY.md`
</output>
