...
@.gsd/ROADMAP.md
@.gsd/STATE.md
@.gsd/phases/13-implement-a-setting-to-disable-chat-terminal-switchbutton-on-tabs/13-RESEARCH.md
</context>
...
<output>
After completion, create `.gsd/phases/13-implement-a-setting-to-disable-chat-terminal-switchbutton-on-tabs/13-01-SUMMARY.md`
</output>
