...
@.gsd/ROADMAP.md
@.gsd/STATE.md
@.gsd/phases/6.4-bugfix-session-resume-claudesessionid-not-persisted-across-restarts/6.4-01-SUMMARY.md
@.gsd/debug/session-resume-after-clear.md
...
<output>
After completion, create `.gsd/phases/6.4-bugfix-session-resume-claudesessionid-not-persisted-across-restarts/6.4-02-SUMMARY.md`
</output>
