...
@.gsd/ROADMAP.md
@.gsd/STATE.md
@.gsd/phases/05-remember-explorer-state/05-RESEARCH.md
@.gsd/phases/05-remember-explorer-state/05-01-PLAN.md
@renderer.js
</context>
...
<output>
After completion, create `.gsd/phases/05-remember-explorer-state/05-02-SUMMARY.md`
</output>
