...
@.gsd/ROADMAP.md
@.gsd/STATE.md
@.gsd/phases/9-remember-window-state-on-windows/9-CONTEXT.md
@.gsd/phases/9-remember-window-state-on-windows/9-RESEARCH.md
@src/main/windows/MainWindow.js
...
<output>
After completion, create `.gsd/phases/9-remember-window-state-on-windows/9-01-SUMMARY.md`
</output>
