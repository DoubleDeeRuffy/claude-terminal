...
- `.gsd/STATE.md` — Phase 07-01 decision: "Settings read at call-time (getSetting at runtime) in key handler — toggles take effect immediately without re-attaching xterm handlers"
