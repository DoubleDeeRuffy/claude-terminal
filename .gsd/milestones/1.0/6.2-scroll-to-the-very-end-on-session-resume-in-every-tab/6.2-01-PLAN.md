...
@.gsd/ROADMAP.md
@.gsd/STATE.md
@.gsd/phases/6.2-scroll-to-the-very-end-on-session-resume-in-every-tab/6.2-RESEARCH.md
@renderer.js
@src/renderer/ui/components/TerminalManager.js
</context>
...
<output>
After completion, create `.gsd/phases/6.2-scroll-to-the-very-end-on-session-resume-in-every-tab/6.2-01-SUMMARY.md`
</output>
