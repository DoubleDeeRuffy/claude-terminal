...
@renderer.js
@src/renderer/ui/components/TerminalManager.js
@.gsd/debug/scroll-to-bottom-race-condition.md
</context>
...
<output>
After completion, create `.gsd/phases/6.2-scroll-to-the-very-end-on-session-resume-in-every-tab/6.2-02-SUMMARY.md`
</output>
