...
@.gsd/ROADMAP.md
@.gsd/STATE.md
@.gsd/phases/17-on-update-installation-the-pinned-taskbar-icon-gets-lost-is-there-a-whole-uninstall-and-install-happening/17-RESEARCH.md
</context>
...
<output>
After completion, create `.gsd/phases/17-on-update-installation-the-pinned-taskbar-icon-gets-lost-is-there-a-whole-uninstall-and-install-happening/17-01-SUMMARY.md`
</output>
