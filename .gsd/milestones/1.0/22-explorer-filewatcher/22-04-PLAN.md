...
@.gsd/ROADMAP.md
@.gsd/STATE.md
@.gsd/phases/22-explorer-filewatcher/22-03-SUMMARY.md
@.gsd/debug/watcher-performance-recursive.md
...
<output>
After completion, create `.gsd/phases/22-explorer-filewatcher/22-04-SUMMARY.md`
</output>
