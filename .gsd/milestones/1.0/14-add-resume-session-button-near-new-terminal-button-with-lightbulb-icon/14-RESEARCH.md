...
- `.gsd/phases/03-new-terminal-button/03-01-SUMMARY.md` — confirmed Phase 3 patterns and conventions used for btn-new-terminal (matches what is seen in upstream/main)
