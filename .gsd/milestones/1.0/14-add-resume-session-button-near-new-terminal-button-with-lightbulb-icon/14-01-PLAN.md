...
@.gsd/ROADMAP.md
@.gsd/STATE.md
@.gsd/phases/14-add-resume-session-button-near-new-terminal-button-with-lightbulb-icon/14-CONTEXT.md
@.gsd/phases/14-add-resume-session-button-near-new-terminal-button-with-lightbulb-icon/14-RESEARCH.md
</context>
...
<output>
After completion, create `.gsd/phases/14-add-resume-session-button-near-new-terminal-button-with-lightbulb-icon/14-01-SUMMARY.md`
</output>
