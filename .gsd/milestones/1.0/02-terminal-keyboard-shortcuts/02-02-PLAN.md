...
@.gsd/ROADMAP.md
@.gsd/STATE.md
@.gsd/phases/02-terminal-keyboard-shortcuts/02-RESEARCH.md
@.gsd/phases/02-terminal-keyboard-shortcuts/02-01-SUMMARY.md
@src/renderer/ui/components/TerminalManager.js
</context>
...
<output>
After completion, create `.gsd/phases/02-terminal-keyboard-shortcuts/02-02-SUMMARY.md`
</output>
