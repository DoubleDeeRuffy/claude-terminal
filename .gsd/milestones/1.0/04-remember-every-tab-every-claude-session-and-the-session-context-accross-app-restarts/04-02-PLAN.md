...
@.gsd/ROADMAP.md
@.gsd/STATE.md
@.gsd/phases/04-remember-every-tab-every-claude-session-and-the-session-context-accross-app-restarts/04-CONTEXT.md
@.gsd/phases/04-remember-every-tab-every-claude-session-and-the-session-context-accross-app-restarts/04-RESEARCH.md
@.gsd/phases/04-remember-every-tab-every-claude-session-and-the-session-context-accross-app-restarts/04-01-SUMMARY.md
@renderer.js
...
<output>
After completion, create `.gsd/phases/04-remember-every-tab-every-claude-session-and-the-session-context-accross-app-restarts/04-02-SUMMARY.md`
</output>
