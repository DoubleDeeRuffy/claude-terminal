...
@.gsd/ROADMAP.md
@.gsd/STATE.md
@.gsd/phases/05-remember-explorer-state/05-01-SUMMARY.md
@.gsd/phases/05-remember-explorer-state/05-02-SUMMARY.md
@.gsd/phases/5.1-save-explorer-state-within-app-starts-and-remember-scroll-position/5.1-RESEARCH.md
@src/renderer/ui/components/FileExplorer.js
@src/renderer/services/TerminalSessionService.js
</context>
...
<output>
After completion, create `.gsd/phases/5.1-save-explorer-state-within-app-starts-and-remember-scroll-position/5.1-01-SUMMARY.md`
</output>
