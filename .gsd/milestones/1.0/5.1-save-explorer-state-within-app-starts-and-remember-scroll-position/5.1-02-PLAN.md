...
@.gsd/phases/5.1-save-explorer-state-within-app-starts-and-remember-scroll-position/5.1-01-SUMMARY.md
@renderer.js
...
<output>
After completion, create `.gsd/phases/5.1-save-explorer-state-within-app-starts-and-remember-scroll-position/5.1-02-SUMMARY.md`
</output>
