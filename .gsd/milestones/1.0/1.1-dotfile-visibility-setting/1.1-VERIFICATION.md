...
human_verification:
  ...
  - test: "With a project open, expand a folder that contains dotfiles (e.g. .git, .gsd). Uncheck Show dotfiles in settings and save. Re-expand the same folder."
...
**Test:** With a project open, expand a directory that contains dotfiles (e.g. the project root with `.git`, `.gsd`). Go to Settings, uncheck "Show dotfiles", click Save. Return to the file explorer and expand the same folder again.
